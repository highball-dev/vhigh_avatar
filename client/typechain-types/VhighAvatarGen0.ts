...
export interface VhighAvatarGen0Interface extends utils.Interface {
  contractName: "VhighAvatarGen0";
  functions: {
    ...
    "ownerBatchMint(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "MINT_LIMIT_PER_WALLET",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "allowedMintCount",
    values: [string]
  ): string;
  encodeFunctionData(
...
export interface VhighAvatarGen0 extends BaseContract {
  contractName: "VhighAvatarGen0";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VhighAvatarGen0Interface;
  ...
  callStatic: {
    ...
    ownerBatchMint(minter: string, overrides?: CallOverrides): Promise<void>;
